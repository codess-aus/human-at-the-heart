...
style: |
  ...
  :root {
    ...
    --fg: #000000;          /* Pure black text - no greys, per accessibility rules */
    --pink: #BF3989;        /* Darker pink for AA contrast on white */
    --purple: #8250DF;      /* GitHub purple - readable on white */
    --cyan: #0969DA;        /* GitHub blue - readable on white */
    --green: #1A7F37;       /* GitHub green - readable on white */
  }
